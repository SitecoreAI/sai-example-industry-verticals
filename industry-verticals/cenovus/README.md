...
This application is a copy of the luxury retail starter, tailored for the Cenovus vertical. It uses the same modular retail patterns, Tailwind and Shadcn styling, and localization support as the Essential Living template.
...
6. Install dependencies:
   from `industry-verticals\cenovus` run `npm install`
...
6. Provide Editing host name `cenovus` as per xmcloud.build.json
