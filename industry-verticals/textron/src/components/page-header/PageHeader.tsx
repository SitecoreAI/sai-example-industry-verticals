 ...
 * (or under `data.<QueryName>.datasource` on some Edge responses).
 * Template fields: "Page Title" / "Page Content" (GraphQL aliases: pageTitle / pageContent).
 */
...
interface Fields {
  ...
  /** Some serializers emit camelCase keys */
  pageTitle?: TextField;
  pageContent?: RichTextField;
...
/** Resolve datasource block whether `data.datasource` or `data.<operation>.datasource`. */
