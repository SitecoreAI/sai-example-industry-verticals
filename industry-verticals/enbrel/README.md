...
Enbrel is a demo website based on the Healthcare (Nova Medical) starter, styled to match the Enbrel patient site branding. The site demonstrates how pharmaceutical patient-facing experiences can create a supportive platform for patient engagement.
...
6. Install dependencies:
   from `industry-verticals\enbrel` run `npm install`
...
6. Provide Editing host name `enbrel` as per xmcloud.build.json
