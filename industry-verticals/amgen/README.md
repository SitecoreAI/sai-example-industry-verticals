...
Amgen is a demo website based on the Healthcare (Nova Medical) starter, designed to represent a modern, patient-focused digital experience. The site demonstrates how healthcare providers can create a trustworthy and user-friendly platform that supports patient engagement.
...
6. Install dependencies:
   from `industry-verticals\amgen` run `npm install`
...
6. Provide Editing host name `amgen` as per xmcloud.build.json
