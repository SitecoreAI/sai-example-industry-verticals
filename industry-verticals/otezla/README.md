...
Otezla is a demo website based on the Healthcare (Nova Medical) starter, styled to match the Otezla patient site branding. The site demonstrates how pharmaceutical patient-facing experiences can create a warm, approachable platform that supports patient engagement.
...
6. Install dependencies:
   from `industry-verticals\otezla` run `npm install`
...
6. Provide Editing host name `otezla` as per xmcloud.build.json
