# Evergy - Demo Site (Next.js)

## Overview

Next.js front end for an **Evergy** demo, modeled on the industry-verticals energy (Gridwell) starter. Evergy serves electricity customers in the Kansas City metro and surrounding region. Point `NEXT_PUBLIC_DEFAULT_SITE_NAME` and Edge context variables at your XM Cloud site configuration for this demo.
...
6. Install dependencies:
   from `industry-verticals/evergy` run `npm install`
...
6. Provide Editing host name `evergy` as per xmcloud.build.json
